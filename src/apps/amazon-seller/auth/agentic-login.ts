...
export default async function loginToAmazonSeller() {
  try {
    ...
    if (resultStr === 'true') return { success: true, message: `Logged in to Amazon Seller as ${credentials.username}` };
