...
- "true" - Login succeeded: you see Etsy seller dashboard
...
export default async function loginToEtsy() {
  try {
    ...
    if (resultStr === 'true') return { success: true, message: `Logged in to Etsy as ${credentials.username}` };
