...
- "true" - Login succeeded: you see Drift dashboard
...
export default async function loginToDrift() {
  try {
    ...
    if (resultStr === 'true') return { success: true, message: `Logged in to Drift as ${credentials.username}` };
