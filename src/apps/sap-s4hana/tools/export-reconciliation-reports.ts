...
function buildPrompt(input: Config['toolInput']): string {
  return `Export Reconciliation Reports in SAP S/4HANA:

- subsidiaryCode: ${input.subsidiaryCode ?? 'N/A'}
- periodFrom: ${input.periodFrom ?? 'N/A'}
- periodTo: ${input.periodTo ?? 'N/A'}
